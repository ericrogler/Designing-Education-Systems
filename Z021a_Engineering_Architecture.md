...
The bad news is you need math and science skills, and plenty of creativity and critical thinking skills, to effectively do those disciplines. The main difficulty in engineering and architecture isn't the content, but the dedication, perseverance, and time and effort to get through it completely and figure out how *and why* things work. 

I'll identify four core branches of engineering: Chemical, Civil, Electrical, and Mechanical. Each branch has sub-disciplines tying back into one (or more) of these four. There's many types of engineers and plenty of crossover, with the primary difference being the core science involved in their discipline. **That said, lumping every type of "engineer" into a single type of engineer is a fallacy, as that'd be a dishonest approach to what they are and what they do. The same can be said for architects.**

Architecture is similar to engineering, and may be considered a subset of engineering, except you take that same problem solving and apply it more towards structures, aesthetics, spatial design, and land utilization (e.g. permeable vs impermeable ground). For example, you're minimizing the cost of materials and labor to create a school campus within budget and deadlines while meeting a quality threshold based on decisions around aesthetics, accessibility, and structural integrity.
...
Talking about your problems can help you think things through and sometimes uncovers solutions as you're talking through them. It doesn't have to be a human you talk to either. It can be a rubber duck instead!

Or even a Blåhaj from IKEA.

It's like thinking aloud except you're reframing the subject, explaining it to someone who may not know what you're talking about, and describing what it should do vs what it actually does right now. The fact it's also an inanimate object means you won't hopefully feel social pressure in case you say something wrong, stutter, or have hesitation problems. It's not a replacement for learning critical thinking skills, of course, but it does help get over the random barrier.
...
Tolerances, from an engineering perspective, are allowable variations for a given product's dimensions/properties. For example, you need a part that is 1 inch long, but you could accidentally make it a touch long (+1/16 inch) or a touch short (-1/16 inch) and *it'd still work fine.* That means you're still within tolerance. Messing up the part too much, like making a 1 inch piece 2 inches instead, means that potentially successful product becomes wasted time, resources, and labor.

From a management perspective, think of tolerances as the allowable margin of error you'll tolerate for your employees and their performance, work, behavior, etc. against established standards, rules, and regulations. You don't want to be *too* tolerant of issues, but also not have so little tolerance you force nothing less than absolute perfection from imperfect human beings and methods.

Tolerances can be set by humans, but are also defined by the materials, tools, and environment itself. For example, you may want a cupholder to be exactly 4.257 inch diameter and tolerate very little mistakes (±0.001 inch tolerance), but your tools can only make a product so well (e.g. ±0.01 inch tolerance) and *any* mistake probably means failure, so you need to settle for 4.25 inch diameter. What you tolerate in an education system may be *far* more lenient than in the aerospace or military industry/system. The requirements demanded by the environment and risk involved widely vary across systems, so what is "tolerated" is different.

This may also mean your tolerances are outside the scope of verification or measurement. For example, if you're measuring to exactly an inch, but your measurement tool can *only* measure down to 1/32 inch increments, you should NOT establish tolerances that are smaller than 1/32 inch! If you do, it's either infeasible or you may need to spend a LOT of time, money, and other resources to get a specialized part or service to verify everything is correct for you. That is *not* fun or easy to do.

Tolerances can be further enhanced when you combine them with other methodologies like Six Sigma (Ohno, 1988). Instead of only "this product isn't done right," you can now track how much waste is generated across X number of products and track how effective and efficient a given process is. It also helps when scaling upwards. If there's very clear indicators you have too much waste and issues at making 100 parts, you're almost certainly going to encounter failures when making 10,000 parts and should implement fixes.

Though partially related to tolerances, you may also encounter part selection problems where you need to balance design considerations with constraints like availability and budget. For example, your calculations show you need 373.25W power output for a computer battery, but the only standardized parts available are 350W and 400W. While you *could* make a battery have that exact output you needed earlier, it'd almost certainly be far more costly to do that. You're usually better off re-doing your calculations constrained around what parts are currently available to you. Standardization of parts is what helps enables manufacturers, businesses, and more produce at scale and keep their options predictable and reliable for themselves and their users.
...
Interoperability defines a product's, or system's, ability to communicate with other products and systems (Slater, 2012). It's why standardization is often considered a good thing because it can enhance interoperability.
...
Translating it into systems instead of products, interoperability could also define how two different organizations of humans cooperate and function together. These organizations, much like software programs and products, also need shared formats and standards to communicate with for reliable information exchanges. For example, it could be a military application like NATO and the US, a medical application like hospitals and insurance, or a business application like transmitting files and payments between organizations.

If I bring this back to education systems, we can look at the different tools and software used to communicate information. An educator's gradebook, for example, should be able to transmit or package its content into formats other programs can read, such as a database to store information in a secure location or a file type spreadsheet software can intake and analyze. If that same gradebook tried to export its data to a program that *couldn't* interpret it, you'd experience issues with your current setup (or new products you're bringing in) and thus need to re-evaluate the interoperability of many products in your education system.

It's also why the general advice of reviewing your current technology "stack" every 1-2 years isn't a bad idea. You confirm technology old and new still plays nice with each other and adequately solves the problems your system(s) encounters. If they don't, then you can proactively solve whatever issues that brings earlier instead of reactively finding out later.

### **Specialization vs Generalization**

*Alternatively: Speciality Products vs General Products*

When you're planning a project, timeline, schedule, etc. you may also consider what exact parts and pieces you need to complete it. The same could be said of bringing on people to complete certain tasks. You may need someone who can do a bit of everything over here but another person really good at doing this one specific thing over there.

For this section, pretend we are building a house and we're ordering fixtures and parts to install inside the house.

Specialty items can take a long time to arrive, arrange, and set up. They can also usually cost a lot. If the order is messed up after the initial lead time, then that risks a massive setback. These items, however, fit your exact specifications to near 100%. 

In cases such as these, generic alternatives, or general orders, are suitable for projects where you're limited on time. If there is an issue, they are easily replaced, they're "standard" items available at many stores, and are generally lower cost. These items may only be 80-90% ideal compared to specialized equipment, but are "good enough" to reasonably complete the project. 

In short, avoid specialty items unless you are willing and able to absorb a significant time and monetary cost to your project. If you are not willing and able, stick with generic items and whatever is "good enough" to complete the project on time and in budget.
...
In terms of background knowledge requirements for physical buildings, you can get by with Algebra and Geometry/Trigonometry for simpler buildings and most residential designs (e.g. Class C and Class B general contracting). Calculus (and sciences utilizing Calculus+) and beyond may better solve the problems related to more complex building designs (e.g. Class A general contracting). Unless you're the engineer of record, you're likely not doing things yourself and instead reading and verifying documents from professional engineers and architects, cost estimates, and schedules to oversee subcontractors and get the building(s) made.
...
If you're in a position where you need to review physical building codes, there's a trick that helps: *simply knowing where to look.* I'll tell you right now memorizing these code books in their entirety is reserved for inspectors and code officials, which you are very likely *not* that. For the average person, it is an endeavor in wasted time and near insanity to memorize every single code detail. Instead of memorizing every detail, you should memorize *where* to find the details. There's nothing wrong with reading building codes from start to finish, but it's probably overwhelming if you're new to their structure, concepts, and terminology. 
...
- For example, perhaps "Means of Egress" and "Accessibility" always comes up in your designs, so you should memorize details from these chapters, but "Definitions" is essentially a dictionary you just look up whenever needed and don't have to memorize completely.
...
- Have access to said code book(s) handy (e.g. [ICC I-Code by Year](https://codes.iccsafe.org/codes/i-codes) website), even if it is read-only access.
...
Additionally, some rules and guidelines are accompanied by maps to highlight where a code variation applies geographically. This usually relates to material science, biology, and environmental effects, such as wind speeds, weathering of concrete, seismic design, stress design for snow loads, termite infestations, and so on.
...
The biggest shorthand rule I have for home design is simple: design it so someone would *want* to live in it. You wouldn't want an airport lounge situation (i.e. busy foot traffic) in a living room where you need to relax instead of wait.

The second rule is the furniture and any other objects inside the home may be the problem rather than the home itself. If simply rearranging furniture and objects could solve the problem, then attempt that first.
...
- Most interior walls are 2x4 studs at 12 inch OC or 16 inch OC
...
- Egress windows are at least 24 inch high by 20 inch wide openings, with a clear opening area of ~6 square feet (minimum of 5.7 square feet net clear opening) and cannot be higher than 44 inches off the *finished* floor.
    - Additionally knowing this formula: Length (inches) x Width (inches) / 144 (i.e. 12 inches squared) = square footage
- 1 pound per square foot = 0.0479 kPa (kilo-Pascals)
- 1 mile per hour = 0.447 m/s (meters per second)
- Standard hallways, and many stairways, in new home construction projects are generally at least 36 to 42 inches wide.
...
- When able, design a bedroom on the same floor as the primary entrance in a house to appeal to disabled people, older people, and people who do not like stairs much.
- You need a 1/4 inch (quarter-inch) of fall for every 1 foot length for water runoff.
...
...At least until you go to the job site. There's staff/machinery lying around doing idle work, you've gone over budget and deadlines, and the crew is pissed at the number of change orders and shifting demands thrown at them, even *with* the clients paying you crazy high prices for all the change orders.

Learn how to read graphics, plans, and schematics and what can/cannot be reasonably done. Also know when to push back against clearly unreasonable requests. It may just save your wallet and sanity.
...
Of particular note for my own endeavors were "topo" (topographic) maps and site plans. Knowing how to read topo maps lets you interpret terrain features, map scales, contour lines, locations of vegetation, triangulating locations on a map, and plenty more. Site plans are useful as they provide a high-level overview of an entire site (i.e. a zoned property) and the location of features like building, foliage, water, road, and parking lot placements.

### **Facility Planning and Production Planning & Inventory Control (PPIC)**

For a far more detailed source, please refer to materials such as *Facilities Planning* by Tompkins et al. (2010).

The type of math required to fully derive and prove models in this area may require at least multivariate Calculus understanding, though much work can be done using results from derivations other people made to be in algebraic form.
...
You may be thinking "what does this even have to do with education systems again?" Education systems will encounter problems with handling resources, capacity, and flow like manufacturing systems might. You still have production, which is delivering quality learning (and perhaps providing meals), inventory for resources to make said learning happen, planning to figure out schedules, where to allocate people, organizing how content is delivered, handling enrollment and student intake, and forecasting demand and costs for education in the future. 

Other processes could be embedded inside existing education systems too, such as the "production line" of a cafeteria to store and process those same items, provide the items they need, get people through queues, and do it all quickly enough to meet deadlines. It could even be perfecting how students may pass along materials from one desk to another desk by applying models for conveyors in a new context.

There's also many parts that at least indirectly or directly translate to education systems present in architecture and engineering, such as handling environment constraints, utilizing layout planning models, and design algorithms. Educators may not need to go to extremes and develop advanced algorithms themselves here. They still should strive to optimize how the space in their classroom is utilized, much like how a manufacturer wants to maximize production capabilities in a given space, if only to keep the environment clean and orderly. Perhaps you're reorganizing something simple, like storage cabinets, but you also want to tinker with a high-powered solution like a block stacking model to help your optimizations.
...
These topics, and related topics, altogether provide processes to assist with planning, scheduling, and controlling processes and systems in *many* different fields, not just education.
...
While it has countless applications, programming is often used to conduct calculations, speed up processes, automate tasks, or do things that a human cannot do within their own limitations. Modern technology also enables more standalone solutions and scripting for wider audiences, bringing traditional engineer work and methods to non-engineer professionals.

As an example of professional use, architects may utilize software and programming for architectural designs. They can manipulate code through programming languages to build plugins and create custom solutions as tools to enhance their work processes and outputs. In this case, it's in service of something else, like geometry or workflow automation, and the programming stays close to the design artifact/software. They could also distribute what they develop to a wider audience, such as people in general or designers, contractors, and so on.

At the end of the day, programming is simply a means to an end or a tool in a toolkit. Many professionals utilizing programming may not be engineers or architects themselves, but simply people using it to solve a problem they're working on.

### **Economic Analysis**

More information from this field is found scattered across various, existing textbooks, such as *Engineering Economic Analysis* by Newnan et al. (2012).
...
Normally this topic is in the realm of finance and business, but engineering and architecture also utilize it alongside many other professionals. While you could get by with many pre-defined formulae and plugging in values for each variable in equations, "engineering-level" economic analysis utilizes specific examples to solve problems and may expect you to know at least multivariate calculus and beyond to fully understand it and bring it to its full potential.

This topic is important for another reason: it gives you the tools to assign monetary values to just about everything you may do within any given business. From the Metrics chapter, recall that metrics are diagnostic measures to reveal whether your current system performs as intended or requires change. That also includes different metrics for economic analysis, such as payback time, return on investment, and net present value, in addition to new tools and formulae to define said metrics.

It also includes delving into topics many younger students wish they knew before they got older, such as explaining taxes, savings, investments, expected costs, depreciation, cash flows, equity, debt, and the time value of money. You may also use this topic to help determine the cost of a constraint or initiative, such as deciding on a new union policy or health insurance policy. On cash flows in particular, it's where people may realize, perhaps for the first time, that cash flow is typically negative in the beginning because you're recuperating from your initial investment "paying back" any capital expeditures.

### **Simulation**

For readers familiar with video games, think about games where you need to build a base, a factory, or a city and manage all of the moving parts in it, such as resource flow, logistics, transportation, and creating products. While the video games of today, as of 2026, are not capable of fully automating all the complexities of real-life environments, they do capture a lot of the essence. More exhaustive software and tools, outside of our video game example, specifically designed for simulation capture even more of their complexites and nuances for professional use, albeit usually at higher cost due to the requirements to create such technology.

For readers unfamiliar with video games, think about what it's like to go to school, the store, or even to another person's house. You leave from one location, take X amount of time to get there, spend Y time at that other location, and perhaps encounter an issue delaying you by Z amount of time. This is one example a simulation applies: all the measureable "steps" in going from point A to point B in order to accomplish some task.

Simple examples can be studied through simulations and we account for many things, such as entities, attribute, logic, decisions, workstations, service points, capacity, processing times, failure/repair cycles, travel paths, types of flow, and many, many, more. This is why I say something like a video game can capture the *essence* of it through models they employ. It'll get the core idea down as it tries to emulates an environment, but the real world is still quite messy. In comparison, the most advanced simulations and setups utilize seemingly limitless variables and assumptions to analyze behaviors and actions.

Within simulations, you can also define multiple metrics as well from all your attributes and data inputs. You can track and further drill down on metrics like utilization rates, throughput, wait times, and queue lengths to further optimize and perform risk analysis.

The beauty of simulations is you can *replicate* scenarios and tests without needing to spend a large amount of money upfront first every time. While they may not be perfect replications, you can get "good enough" replications within a simulation and perform *thousands, if not more,* of replications in the time it takes to do it once in the real world. For example, you could recreate your work process and simulations can estimate what may happen with just one minor or major change. You could also recreate floor plans and develop models for you, or your users, to experience in a virtual setting, like walking through a house or a flight simulator.
...
Overall, the possibilities for what simulations can do increases as technology improves.

### **Operations Research (OR) and Data Science (DS)**

If you've ever had an interest in machine learning (ML), then you've probably heard of operations research as well, which is applied mathematics. It's been around for a long time since at least World War 2 and more specifically at least since the work of Morse and Kimball (1951). There's applications in a lot of areas like airlines, logistics, grocery stores, your route from point A to point B, etc. Some examples of where these topics are used are embedded in other topics I've discussed throughout this chapter and various parts in this book.
...
The main goal of OR is to get a solution as close to optimal as possible. Fully optimal may take too much time so we aim for 99.9% instead of 100%, like antibacterial soap in a bathroom. Afterall, we want a working model that generates a feasible "optimal" solution in a reasonable amount of time. That self-imposed restriction is there because some problems require technology without the capacity to be solved at the scale they demand. Therefore, a model may need tweaking, such as adjusting weights, constraints, and the objective function(s), or even splitting apart one model into multiple models or subsets of a problem.

Data Science (DS) is related to OR and has overlap with it, but is several decades younger by comparison and some perspectives may view DS as a matured and better developed/validated version of OR. Compared to OR, data science strives for accurate models and utilizes real world data to prove the model's value and ensure that model is reproducible, so those perspectives are quite valid.
...
This field isn't limited to engineers and architects and includes many other professionals like doctors and designers. The former two professions utilize it because it informs *how* they should design something for human interaction. Humans are, more often than not, using the products afterall.

To put it in an example, let's say you want to design a chair for someone to sit in. 

First, there's a problem to define: you need to support a human body for prolonged sitting periods and reduce stress on their spine, hips, and legs. Let's also say the hypothesized solution, for your first iteration, is an adjustable, body-conforming chair design. The first iteration is typically a reasonable, educated guess based on the information you know and the assumptions you have going into the problem. The second iteration is either an improvement on the first iteration, or an indication that changes you made across iterations weren't a good idea, so you can safely rule it out for future iterations. Continuous improvement affects this process and fine tunes the final result as you keep iterating over time.
- As an aside, it is also possible to improve *in the wrong direction* across iterations and have it backfire immensely.
