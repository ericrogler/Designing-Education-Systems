...
Sometimes you need to help get a fellow teacher, or substitute teacher, set up in a classroom. You may not have to do it often, but it's better to know how because you may have to do it. The same processes and steps outlined here could apply for what you need to onboard new employees in general inside a company, other system, and so on.

Just because your passporting and information transfer procedures, especially with lesson plans, are long doesn't necessarily mean they'll be good. Quantity =/= quality and clear details/procedures are normally the winners.
...
The other thing to watch for is meetings with administrators. Sometimes they're low-stakes, like a check-in to see how you're doing during their usual routine checkups with staff. Other times they're high-stakes, like a serious meeting over how you're handling duties and compliance as a teacher. Whenever you have any scheduled meeting, take a bit of time to prepare in advance if possible to limit how much you're caught off-guard.

That said, if an administrator comes into a classroom to try and model a lesson or teach a classroom in place of a teacher, and have never taught in a classroom before, I'm going to assume they're the role equivalent of a substitute teacher (which I explain more on below) and may not perform adequately. That's not to say they'll be *bad* at teaching, but if they're not familiar with how teaching works in practice, and jump straight into it, it's typically not going to go well their first time.

I say this even considering other factors such as:
...
Authority does not equal expertise. This also applies for teachers too, not just principals and administrators.

### **Teacher-to-Teacher**

Take, for example, a new teacher is coming into your department or a more seasoned one is transferring in for the first time. There's an orientation period where they're getting their bearings and understanding of the environment. This general onboarding isn't exclusive to teaching; you may see it in tech, nursing, and many other jobs.

Pretend you are the older teacher, rather than a newer teacher. Here are things you probably want your new junior to know about, but may be expanded upon or condensed:
...
You may consider providing sample lesson plans relevant to their subject(s) as references too. 
- This can be just a short bulleted list; nothing too fancy or complicated here.
- There's typically not an obligation, unless forced into it by administration, for teachers to provide *complete* lesson plans and curriculums to other teachers as those are a significant investment of time and effort as well as potential portfolio pieces towards career advancement.
...
The best part? You could include almost all in one file or deliverable. That's simple to maintain.

### **Teacher-to-Substitute/Guest Teacher**

Many parts here may be reminders of topics discussed in previous chapters, but they're still important.

Guest/substitute teachers should ignore a student saying "Our teacher lets us do ___" or something similar. It *could* be true, but it could also not be true and cause issues. This is why you need to properly convey how things are done to minimize misinterpretation.
...
1. Your classroom management plan could be perfect, but it will not stop students from testing boundaries and seeing what they can get away with.
    ...
    - Even if they do have access, they may not use the tools effectively.
    - A substitute teacher has diminished authority from the start. They normally do not have rapport already established.
...
Some passporting and information transfer, which normally may violate FERPA/HIPAA if distributed, may be shared to those with legitimate educational interests in your institution, like the substitute teacher in charge of students you're normally responsible for as their teacher of record. As examples of laws you may encounter regarding this:
...
Despite any restrictions and allowances, the primary teacher and the school are still responsible for informing the substitute teacher about specific student requirements and what should be done in the classes covered. Failure to do so may provide the substitute teacher reasonable defense for not meeting these requirements.
...
This binder may be expected to contain the following items accessible inside of it:
...
Despite the "emergency" in the title, these plans should be written like a SOP (standard operating procedure) and inform how you structure regular sub plans. In short, it covers the *essential information* that stays (mostly) consistent through the entire teaching period and can apply across multiple classrooms. It can be a bit long depending on what needs coverage, but keep it short when possible.
...
To think about it another way: you're suddenly dropped into a classroom and you have no idea what to do. What essential information should you know to function effectively as a teacher?

That's the question this plan should answer succinctly; if it doesn't, it's not a good emergency substitute plan and you need to fix it. For that effect, you should include information like the following:
...
- A seating chart (if one is made) and alphabetical name list by first/last name.
    ...
    - This applies for every classroom you're teaching. If you don't know where to seat people, you spend more time and energy doing that instead of teaching.
- Staff bathroom, staff lounge, and front/administrative office locations.
    - You can include a copy of the campus/facility map and/or floor plan if desired.
...
Here is an example of a work plan below for each period. It includes what students need to do, how to do it, and what happens when they're done early. The parts you change are bolded. For any usernames and passwords, or login credentials, you provide, **change them as soon as possible after the coverage period is over.** That's for *your* own security.
...
- Students do **[Assignment]** today.
    - Available on **[Platform/Medium]** located at **[Computer/Desk/Etc.]**.
...
Repeat the above template for each relevant period. The intention of this template (and subsequent examples) is to cover each part of the assigned work without being verbose. We're also designing for scannability over readability, so a substitute can quickly check what students should be working on without being bogged down by details.
...
- **[Assignment 2]**
    ...
    - Expected to complete **[In-Class/Out-of-Class/Partially done]**.
    - Due date is **[Month Day, Year]** or **[End of class/End of day/Tomorrow/By midnight]**.
- (Copy+paste more of the above as needed)
- If students finish all assigned work early, have them do:
    - **[Assignment]** on **[Platform/Medium]** located **[Computer/Desk/Etc.]** due **[Month Day, Year]** or **[End of class/End of day/Tomorrow/By midnight]**
    - **[Option B (General)]**.
...
As for special needs information, throw that onto the period where relevant. Here's an example layout below. Remember that substitute teachers do have legitimate educational interests, so typically should be told if an IEP/504/otherwise exists.
...
- Provide information about what they'll cover *before* they arrive.
...
- Don't get them in trouble for voicing legitimate complaints and concerns about the class, other staff, etc.
